    ...
    <form onSubmit={save} className="space-y-6">
      <div className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-[10px] font-black text-[#7a91b5] uppercase tracking-widest mb-1.5 ml-1">Password</label>
            <input
              type="password"
              value={form.password}
        ...
        <div>
          <label className="block text-[10px] font-black text-[#7a91b5] uppercase tracking-widest mb-1.5 ml-1">Broker Server</label>
          <input
            type="text"
            value={form.server}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-[10px] font-black text-[#f5c842] uppercase tracking-widest mb-1.5 ml-1">Risk % Per Trade</label>
            <input
              type="number"
              step="0.1"
